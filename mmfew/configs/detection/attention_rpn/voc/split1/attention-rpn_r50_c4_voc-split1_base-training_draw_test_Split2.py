...
data = dict(
    train=dict(
        ...
        query_dataset=dict(classes='ALL_CLASSES_SPLIT2'),
        support_dataset=dict(classes='ALL_CLASSES_SPLIT2')),
...
evaluation = dict(interval=6000,class_splits=['BASE_CLASSES_SPLIT2', 'NOVEL_CLASSES_SPLIT2'])
