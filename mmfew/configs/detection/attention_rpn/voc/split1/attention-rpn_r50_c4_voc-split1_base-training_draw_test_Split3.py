...
data = dict(
    train=dict(
        ...
        query_dataset=dict(classes='ALL_CLASSES_SPLIT3'),
        support_dataset=dict(classes='ALL_CLASSES_SPLIT3')),
...
evaluation = dict(interval=6000,class_splits=['BASE_CLASSES_SPLIT3', 'NOVEL_CLASSES_SPLIT3'])
