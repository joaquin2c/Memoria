...
data = dict(
    ...
    train=dict(
		...
		dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/sofa/trainval.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/motorbike/trainval.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/bird/trainval.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/cow/trainval.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/bus/trainval.txt'),
            ],
    ...
    model_init=dict(
        ...
        ann_cfg=[
                ...
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/sofa/test.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/motorbike/test.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/bird/test.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/cow/test.txt'),
                dict(
                     type='ann_file',
                     ann_file=data_root+'Draw/bus/test.txt'),
            ],
        img_prefix=data_root,
