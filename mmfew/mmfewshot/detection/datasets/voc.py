...
# pre-defined classes split for few shot setting (modified to Draw!)
VOC_SPLIT = dict(
    ALL_CLASSES_SPLIT1=('aeroplane', 'bicycle', 'boat', 'car', 'cat',
    ...
    ALL_CLASSES_SPLIT2=('bicycle', 'bird', 'boat', 'bus', 'car', 'cat',
                        ...
                        'aeroplane', 'cow', 'horse', 'sofa'),
    ALL_CLASSES_SPLIT3=('aeroplane', 'bicycle', 'bird', 'bus', 'car',
                        'chair', 'cow', 'diningtable', 'dog', 'horse',
                        'train', 'tvmonitor', 'boat',
                        'cat', 'motorbike', 'sheep', 'sofa'),
    NOVEL_CLASSES_SPLIT1=('bird', 'bus', 'cow', 'motorbike', 'sofa'),
    NOVEL_CLASSES_SPLIT2=('aeroplane', 'cow', 'horse', 'sofa','tvmonitor'),
    NOVEL_CLASSES_SPLIT3=('boat', 'cat', 'motorbike', 'sheep', 'sofa'),
    BASE_CLASSES_SPLIT1=('aeroplane', 'bicycle', 'boat', 'car',
                         'cat', 'chair', 'diningtable', 'dog', 'horse',
                         'sheep', 'train', 'tvmonitor'),
    BASE_CLASSES_SPLIT2=('bicycle', 'bird', 'boat', 'bus', 'car', 'cat',
                         'chair', 'diningtable', 'dog', 'motorbike',
                         'sheep', 'train'),
    BASE_CLASSES_SPLIT3=('aeroplane', 'bicycle', 'bird', 'bus',
...
@DATASETS.register_module()
class DrawSuppFewShotVOCDataset(BaseFewShotDataset):
    """VOC dataset for few shot detection.
