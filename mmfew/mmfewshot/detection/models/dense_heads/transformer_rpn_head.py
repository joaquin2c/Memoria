...
"""This file modifies AttentionRPNHead to use multi-head attention between query
and support features, instead of DepthWiseCorrelation. The only modifications
were to change the aggregation type in the constructor and to skip the Global
Average Pooling in the forward_train method.

TODO: extend the previous class with just the modifications to avoid duplicate
code.
"""


@HEADS.register_module()
class TransformerRPNHead(RPNHead):
